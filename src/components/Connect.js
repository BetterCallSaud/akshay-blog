import { Footer, Navbar, SubscribeSection } from "./PageComponents";
          ...
          <div>
            <div>
              <a
                rel="noreferrer"
                target={"_blank"}
                href="mail:akshayanjana04@gmail.com"
              >
                <FontAwesomeIcon
                  icon={faEnvelope}
                  className="text-6xl mb-4 hover:text-slate-700 transition-all duration-500"
                />
              </a>
            ...
            <div>
              <a
                rel="noreferrer"
                target={"_blank"}
                href="https://instagram.com/akshay_arya30"
              >
                <FontAwesomeIcon
                  icon={faInstagram}
                  className="text-6xl mb-4 hover:text-slate-700 transition-all duration-500"
          ...
          <div>
            <div>
              <a
                rel="noreferrer"
                target={"_blank"}
                href="https://www.facebook.com/akshay.aanjna.7"
              >
                <FontAwesomeIcon
                  icon={faFacebook}
                  className="text-6xl mb-4 hover:text-slate-700 transition-all duration-500"
            ...
            <div>
              <a
                rel="noreferrer"
                target={"_blank"}
                href="https://twitter.com/akshayanjana3"
              >
                <FontAwesomeIcon
                  icon={faTwitter}
                  className="text-6xl mb-4 hover:text-slate-700 transition-all duration-500"
